# <a name="kasformflatsummary"></a><span data-ttu-id="f87d5-101">KASFormFlatSummary</span><span class="sxs-lookup"><span data-stu-id="f87d5-101">KASFormFlatSummary</span></span>
```typescript
