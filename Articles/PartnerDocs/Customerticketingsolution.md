...
Lorsque l’état du ticket change, nous aurions besoin de mettre à jour l’état de la carte qui a été envoyée. Pour cela, nous utiliserons le point de terminaison>>/Properties actions/<<. Dans l’exemple ci-dessous, nous allons mettre à jour l’état du ticket sur résolu. Notez que l’actionId est l’ID de l’action envoyée à l’étape précédente.
